...
def main():
    ...
    # ----------------------------------------数据----------------------------------------
    data_1 = np.random.rand(128, 192, 8, 8).astype(np.float32)
    data_2 = np.random.rand(128, 192, 8, 8).astype(np.float32)

    target_cla_1 = np.random.randint(0, 10, (128, 1))
    target_cla_2 = np.random.randint(0, 10, (128, 1))

    dataloader_cla = [(data_1, target_cla_1), (data_2, target_cla_2)]
    # ----------------------------------------模型----------------------------------------
